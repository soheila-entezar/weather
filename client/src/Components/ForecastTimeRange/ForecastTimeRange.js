...
function ForecastTimeRange() {
  return (
    ...
    <div className="flex justify-around">
      ...
      <div className="w-[55%] flex flex-grow items-center justify-center flex-wrap">
        <div className="text-[10px] text-slate-50">جمعه, 1اردیبهشت</div>
        <div className="text-[10px] text-slate-300">بارش باران</div>
      </div>
      <div className="w-[20%] border-l-[1px] border-stone-500  ">
        <div className="w-[100%] text-[14px] text-slate-50 flex justify-center  flex-grow items-center">9 <WiDegrees />
          
        </div>
        <div className=" w-[100%] text-[14px] text-slate-50 flex justify-center flex-grow items-center">16 <WiDegrees />
